...
int main (int argc, char **argv) {
  ...
  if (argc - optind != 7) {
    ...
    fprintf(stderr,"usage: classify_v2 [-l len] [-r n_rseq] [-i n_iseq] taxonomy rseqFASTA taxonomy2rseq modelparameters scalingfile probability_threshold inputFASTA\n");
    exit(0);
  }
